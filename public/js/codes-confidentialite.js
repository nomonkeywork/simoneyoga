...
function initConfidentialite() {
    console.log("🔄 Initialisation confidentialite");
    setTitle(false);
    setFAQNav(false);
    // ✅ Vérifier qu'on est bien sur la page confidentialite
    const qrContainer = document.querySelector('.qr-container');
    const isConfidentialitePage = document.querySelector('div[data-barba-namespace="confidentialite"]');
    const isMLPage = document.querySelector('div[data-barba-namespace="ml"]');
    if (!isConfidentialitePage && !isMLPage) {
        console.log('⚠️ Pas sur les pages confidentialite ou mentions légales, skip initConfidentialite()');
        return;
    }
    ...
    createFluidCanvas("confidentialite-fluid", "images/visual-5.jpg");
    createFluidCanvas("ml-fluid", "images/visual-8.jpg");
    ...
    /*  ------------------ confidentialite --------------------- */
    // Système d'accordéon confidentialite
    ...
    const mobileSelect = document.getElementById('confidentialite-mobile-select');
...
// ✅ Appeler au chargement initial de la page confidentialite uniquement
document.addEventListener('DOMContentLoaded', function () {
    const isconfidentialitePage = document.querySelector('[data-barba-namespace="confidentialite"]');
    const isMLPage = document.querySelector('[data-barba-namespace="ml"]');
    if ((isconfidentialitePage || isMLPage) && typeof initConfidentialite === 'function') {
        console.log('❓ Chargement initial : pages confidentialite ou mentions légales détectées, appel de initConfidentialite()');
        initConfidentialite();
    } else {
        console.log('📄 Chargement initial : pas sur la confidentialite ou mentions légales, skip initConfidentialite()');
    }
});